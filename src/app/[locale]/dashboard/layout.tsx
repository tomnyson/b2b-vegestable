    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 ${
        ...
        <div className="flex flex-col h-full bg-white/90 backdrop-blur-xl shadow-2xl border-r border-white/20">
          ...
          >
            <svg 
              className={`w-4 h-4 text-gray-600 group-hover:text-emerald-600 transition-colors ${
          ...
          <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            {navigation.map((item) => {
              ...
              return (
                ...
                >
                  <span className={`flex-shrink-0 ${isActive ? 'text-white' : 'text-gray-500 group-hover:text-emerald-600'}`}>
                    {item.icon}
                  </span>
                  {sidebarOpen && (
