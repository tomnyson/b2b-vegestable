      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-6 group hover:shadow-2xl transition-all duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4 flex-1">
                  <h2 className="text-sm font-medium text-gray-500">{t('totalOrders')}</h2>
            ...
            {/* <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-6 group hover:shadow-2xl transition-all duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4 flex-1">
                  <h2 className="text-sm font-medium text-gray-500">{t('totalRevenue')}</h2>
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-6 group hover:shadow-2xl transition-all duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4 flex-1">
                  <h2 className="text-sm font-medium text-gray-500">{t('customers')}</h2>
                  <p className="text-2xl lg:text-3xl font-bold text-gray-900">{summary.total_customers.toLocaleString()}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-6 group hover:shadow-2xl transition-all duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4 flex-1">
                  <h2 className="text-sm font-medium text-gray-500">{t('products')}</h2>
          ...
          {/* <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('orderCountByHour')}</h3>
                <div className="h-64">
                  {todayOrders.some(item => item.count > 0) ? (
                    ...
                    <div className="h-full flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500 font-medium">{t('noOrdersYetToday')}</p>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">{t('revenueByHour')}</h3>
                <div className="h-64">
                  {todayOrders.some(item => item.revenue > 0) ? (
                    ...
                    <div className="h-full flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500 font-medium">{t('noRevenueGeneratedToday')}</p>
                      </div>
                    </div>
                  )}
                </div>
                ...
                {orderHistory.length > 0 ? (
                  ...
                  <div className="h-full flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-gray-500 font-medium">{t('noOrderHistoryDataAvailable')}</p>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Order Status Chart */}
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-6 lg:p-8">
              <h2 className="text-xl lg:text-2xl font-bold text-gray-900 mb-6">{t('ordersByStatus')}</h2>
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6">
                <div className="h-64">
                  {orderCounts.length > 0 ? (
                    ...
                    <div className="h-full flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500 font-medium">{t('noStatusDataAvailable')}</p>
                      </div>
                    </div>
                  )}
                </div>
            ...
            {/* Top Products Chart */}
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-6 lg:p-8">
              <h2 className="text-xl lg:text-2xl font-bold text-gray-900 mb-6">{t('bestSellingProducts')}</h2>
              <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6">
                <div className="h-64">
                  {topProducts.length > 0 ? (
                    ...
                    <div className="h-full flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-500 font-medium">{t('noProductSalesDataAvailable')}</p>
                      </div>
                    </div>
                  )}
                </div>
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
            <div className="px-6 lg:px-8 py-6 border-b border-gray-100">
              <h2 className="text-xl lg:text-2xl font-bold text-gray-900">{t('bestSellingProducts')}</h2>
            </div>
                    ...
                    <tr>
                      <td colSpan={3} className="px-6 py-12 text-center">
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-gray-500 font-medium">{t('noProductDataAvailable')}</p>
                        </div>
                      </td>
                    </tr>
                  )}
